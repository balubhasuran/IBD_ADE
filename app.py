...
# Read dataset (CSV)
df_interact = pd.read_csv("AE_Counts.csv")
...
if genre == 'Drug Class':
    ...
    # Define list of selection options and sort alphabetically
    node_list = ['Cardiac disorders','Eye disorders ','Failure of Intended Efficacy ','Gastrointestinal disorders ','General disorders and administration site conditions','Infections and infestations ','Metabolism and nutrition disorders','Musculoskeletal and connective tissue disorders','Nervous system disorders','Renal and urinary disorders','Skin and subcutaneous tissue disorders','Vascular disorders','Endocrine disorders','Injury, poisoning and procedural complications','Hepatobiliary disorders','Psychiatric disorders','Respiratory, thoracic and mediastinal disorders','Investigations','Blood and lymphatic system disorders ','Neoplasms benign, malignant and unspecified (incl cysts and polyps)']
    node_list.sort()
